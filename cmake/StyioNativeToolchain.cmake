function(styio_native_toolchain_has_clang root out_result)
  ...
  if(EXISTS "${root}/bin/clang.exe" AND EXISTS "${root}/bin/clang++.exe")
    set(${out_result} TRUE PARENT_SCOPE)
    return()
  endif()
  ...
  if(EXISTS "${root}/bin/clang-18.exe" AND EXISTS "${root}/bin/clang++-18.exe")
    set(${out_result} TRUE PARENT_SCOPE)
    return()
  endif()
  if(EXISTS "${root}/bin/clang-cl" OR EXISTS "${root}/bin/clang-cl.exe")
    set(${out_result} TRUE PARENT_SCOPE)
    return()
  endif()
