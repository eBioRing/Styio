...
| SNY-AUD-012 | 3, 5 | Closed | `src/StyioServices/StyioLSP/Server.cpp:247-322` | `Content-Length` parsing now validates, caps oversized frames, drains safely, and ignores overflowing string request IDs without throwing. | Covered by `StyioLspServer.SkipsMalformedFramesAndHandlesLargeStringIds`. |
