...
Dated tracked reports that have been fully absorbed must be marked and cleaned through `python3 scripts/docs-lifecycle.py ... --family audit`; the archive manifest and generated ledger retain provenance without retaining a second raw copy.
