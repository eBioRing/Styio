...
Team runbooks must follow [../templates/TEAM-RUNBOOK-TEMPLATE.md](../templates/TEAM-RUNBOOK-TEMPLATE.md). The gate checks:
...
[../../teams/COORDINATION-RUNBOOK.md](../../teams/COORDINATION-RUNBOOK.md) is checked against a coordinator-specific H2 shape:
...
| `SEMA-IR-RUNBOOK.md` | `src/StyioAST/`, `src/StyioAnalyzer/`, `src/StyioIR/`, `src/StyioToString/`, `src/StyioSession/` |
| `CODEGEN-RUNTIME-RUNBOOK.md` | `src/StyioCodeGen/`, `src/StyioJIT/`, `src/StyioExtern/`, `src/StyioRuntime/` |
| `CLI-NANO-RUNBOOK.md` | `src/main.cpp`, `src/StyioConfig/`, `configs/`, `scripts/gen-styio-nano-profile.py`, `docs/for_spio/` |
| `IDE-LSP-RUNBOOK.md` | `src/StyioIDE/`, `src/StyioLSP/`, `docs/for-ide/`, `tests/ide/` |
...
| `DOCS-ECOSYSTEM-RUNBOOK.md` | `README.md`, `docs/`, `templates/`, docs maintenance scripts, `scripts/delivery-gate.sh`, `scripts/team-docs-gate.py` |
...
When any team runbook or `COORDINATION-RUNBOOK.md` changes, [../../teams/DOC-STATS.md](../../teams/DOC-STATS.md) must also be refreshed in the same delivery. The statistics file uses the `scripts/docs-audit.py` word-count and character-count rules.
...
2. If the error is structural, align the file with [../templates/TEAM-RUNBOOK-TEMPLATE.md](../templates/TEAM-RUNBOOK-TEMPLATE.md) or the coordinator shape above.
3. Update only what the delivery actually changed: owned surface, workflow, gates, cross-team dependencies, or handoff notes.
4. If the runbook content changes, refresh [../../teams/DOC-STATS.md](../../teams/DOC-STATS.md).
