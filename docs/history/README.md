...
2. Keep durable workflow rules in root `workflows/`.
...
2. Read the owning `design/specs/teams` documents and the relevant `workflows/` document for the topic you are touching.
3. Check [`../../workflows/CHECKPOINT-WORKFLOW.md`](../../workflows/CHECKPOINT-WORKFLOW.md) for the current recovery gate.
