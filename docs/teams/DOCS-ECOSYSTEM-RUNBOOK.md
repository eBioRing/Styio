...
116. When bounded resource-selector history gains handle-owned families such as list or dict, update Resource Topology, current-state/gap rollups, the IM-D4 inventory, `workflows/TEST-CATALOG.md`, Sema / IR, Codegen / Runtime, Test Quality, and `DOC-STATS.md` together; name the closed families and keep tuple, matrix, unbounded selector snapshots, and broader copy semantics open unless separately proven.
