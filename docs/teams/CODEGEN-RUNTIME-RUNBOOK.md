...
3. High: handle table, ownership lifecycle, JIT symbol policy, or resource/stream execution behavior. Use checkpoint workflow, add ADR, and run soak/perf gates.
