...
17. When changing `perf-route.sh`, `perf-report.py`, or `soak-minimize.sh`, keep report schema, route labels, and minimization output aligned with `styio-benchmark` consumers before promoting the benchmark gate.
