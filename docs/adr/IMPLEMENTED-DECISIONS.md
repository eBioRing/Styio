...
| Package handoff | `styio` owns compiler-side nano and compile-plan producer contracts; package-manager UX and registry lifecycle stay outside this repository. | [repository map](../specs/REPOSITORY-MAP.md), [Pafio handoff](../external/for-pafio/Styio-Nano-Pafio-Coordination.md), [CLI contract matrix](../plans/Styio-Ecosystem-CLI-Contract-Matrix.md) |
