...
| `plan/` | [Plan Index](./plan/INDEX.md) | Define the tracked Better Plan v3 workspace under docs/plan/, with current delivery state indexed by Manifest.json and unfinished product work owned by the next-stage gap ledger. |
