...
| `plans/` | [Plans Index](./plan/repository-delivery-convergence/Evidence.md) | Define the scope and naming rules for the small set of active implementation plans under docs/plan/; absorbed plans are removed from the current tree after durable rules move into active docs, and the generated file inventory lives in INDEX.md. |
