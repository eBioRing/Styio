...
| `Styio-Resource-Topology.md` | [Styio — Resource Topology & @ Semantics (Design Spec v2)](./Styio-Resource-Topology.md) | @ 三角色、有界缓冲、:= 驱动、影子写入 -> 等 目标资源拓扑 的单一叙述；与当前编译器差异见 ../review/Logic-Conflicts.md。Golden Cross 设计级示例见 §8；agent 宪法内嵌代码仍归 ../specs/AGENT-SPEC.md §12.3。 |
