...
| `Styio-Exact-Literals-and-Builtin-Add.md` | [Styio Exact Literals and Built-in Add](./Styio-Exact-Literals-and-Builtin-Add.md) | Define the accepted Q05-LIT-ADD semantics for exact numeric |
