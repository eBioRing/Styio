...
| Explicit selector copy `snapshot << @price[-n..]` / `snapshot << @price[...]` | **Implemented for bounded `i64`, `f64`, `bool`, `char`, and `string` selector snapshots; scalar latest reads and broader type-directed `<<` clone/copy remain staged** |
