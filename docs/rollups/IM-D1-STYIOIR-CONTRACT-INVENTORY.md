...
| Regression coverage | Contract tests cover active defaults, no-op lowering, char lowering, resource-method char, format-string, list/list-op, and dict inline cloning, fail-closed unsupported AST nodes, inactive verifier rejection, and codegen rejection | [../../tests/security/styio_security_test.cpp](../../tests/security/styio_security_test.cpp), [../../tests/styio_test.cpp](../../tests/styio_test.cpp) |
