...
| Pass manager | `StyioIRPassManager` supports opt-level gating (0: verify-only, 1: canonicalization), before/after verifier checks, per-pass timing, and optional IR dumps | [../../src/StyioLowering/StyioIROptimizer.cpp](../../src/StyioLowering/StyioIROptimizer.cpp) |
