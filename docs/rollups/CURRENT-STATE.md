...
3. Resource Topology v2 remains a dedicated migration track owned by [`../design/Styio-Resource-Topology.md`](../design/Styio-Resource-Topology.md), [`../design/syntax/ACTIVE-SYNTAX.md`](../design/syntax/ACTIVE-SYNTAX.md), and the current gap ledger. Bounded selector history is now executable for scalar/string/char/bool/f64/i64 values plus list-valued and dict-valued resources; tuple/matrix history, unbounded snapshots, and broader topology-resource copy remain open.
