...
13. Plans scope and status rules: [plan/README.md](./plan/README.md)
...
2. Follow its links into the owning SSOT in `design/`, `specs/`, `../workflows/`, `teams/`, `plan/`, or current rollups.
...
6. Before creating a Markdown file, search [INDEX.md](./INDEX.md), owning SSOTs, runbooks, workflows, plan docs, rollups, and [adr/README.md](./adr/README.md); update an existing owner unless a new single-purpose document is necessary.
