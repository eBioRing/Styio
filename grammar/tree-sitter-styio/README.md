...
in `src/StyioServices/StyioIDE/Syntax.cpp`. Tree-sitter is responsible for CST nodes, error-node discovery, and
...
- `src/StyioServices/StyioIDE/TreeSitterBackend.cpp` adapts Tree-sitter nodes into the repository-local
