...
| `TEST-CATALOG.md` | [Styio 测试目录（按功能域）](./TEST-CATALOG.md) | 将 里程碑集成测试 按功能域映射到 输入 .styio、golden/副作用路径与 ctest 命令；权威自动化入口见 tests/CMakeLists.txt。维护规则见 ../docs/specs/DOCUMENTATION-POLICY.md，项目级优先级顺序见 ../docs/specs/PRINCIPLES-AND-OBJECTIVES.md。 |
| `TEST-CATALOG.toml` | [Styio Test Catalog](./TEST-CATALOG.toml) | Map milestone and feature-domain tests to inputs, goldens, side effects, and CTest commands. |
