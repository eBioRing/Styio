...
| `DELIVERY-GATE.md` | [Styio Unified Delivery Gate](./DELIVERY-GATE.md) | Define the common delivery-floor entrypoint for Styio so contributors can run repository hygiene, the unified docs gate, and checkpoint health through one command before checkpoint merge or branch delivery. |
| `DELIVERY-GATE.toml` | [Styio Unified Delivery Gate](./DELIVERY-GATE.toml) | Define the common delivery-floor entrypoint for hygiene, docs, and checkpoint health. |
